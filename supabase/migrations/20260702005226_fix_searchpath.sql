-- Aktifkan pgcrypto untuk hashing password di fungsi create_employee_with_auth
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Re-create fungsi dengan pgcrypto yang sudah aktif
...
BEGIN
  ...
  INSERT INTO profiles (
    ...
    p_role, p_employee_status, p_department, p_position,
    false, NOW()
  );
